...
Translations: [Bahasa Indonesian](http://bulsara.host.sk/index.php?p=2005) [Belorussian](https://www.dussk.co/translation/ask-smart-questions/) [Brazilo-Portuguese](http://blogofscience.com/perguntas.html) [Chinese (Traditional)](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way) [Croatian](http://www.bildelestore.dk/blog/kako-postavljati-pitanja-na-pametan-nacin) [Czech](http://scientificachievements.com/jak-se-ptat-chytry-zpusob/) [Dutch](http://docs.jaspervries.nl/smart-questions/) [Estonian](http://glory4cars.com/edu/kuidas-esitada-kusimusi-nutikas-viis/) [French](http://www.gnurou.org/documents/smart-questions-fr.html) [Georgian](http://maxo127.narod.ru/Geo/Articles/smart-questions_ge.html) [German](http://www.tty1.net/smart-questions_de.html) [Greek](http://www.dionyziz.com/howto-smart-questions-gr/) [Hindi](http://kntuniversity.org/how-to-ask-questions-the-smart-way/) [Hungarian](http://www.forallworld.com/milyen-kerdeseket-okosan/) [Irish Gaelic](http://www.autoteileprofi.ch/blog/2016/04/01/newly-sin-iarr-ar-kuestions-tkhe-smart-wai) [Indonesion](https://www.chameleonjohn.com/translations/smart-questions-Indonesian)[Japanese](http://www.ranvis.com/articles/smart-questions.ja.html) [Lithuanian](http://myscres.com/articles/kaip-uzduoti-klausimus-protinga-buda.html) [Polish](http://rtfm.killfile.pl/) [Portuguese](http://science-lakes.com/article43.html) [Romanian](http://wiki.lug.ro/mediawiki/index.php/Cum_se_pun_%C3%AEntreb%C4%83ri_%C3%AEn_mod_inteligent) [Russian](http://maddog.sitengine.ru/smart-question-ru.html) [Serbian](http://www.autoersatzteile.de/blog/how-to-ask-questions-the-smart-way-in-serbian) [Spanish](http://www.sindominio.net/ayuda/preguntas-inteligentes.html) [Turkish](https://github.com/procyberian/How-To-Ask-Questions-The-Smart-Way/blob/master/How-To-Ask-Questions-The-Smart-Way.tr.md) [Uzbek](http://www.bestcarzin.com/blog/smart-questions-uzb/) If you want to copy, mirror, translate, or excerpt this document, please see my [copying policy](http://www.catb.org/~esr/copying.html).

## Sorumluluk reddi beyanı

Birçok proje sitesi yardım kısmında bu belgeyi bağlantı olarak bırakıyor.Bu sorun değildir, ve ayrıca amaçladığımız kullanım budur. Ancak proje sayfanız için böyle bir bağlantı oluşturan bir web yöneticisiyseniz, lütfen bağlantının yanında *projeniz için bir yardım masası olmadığımızı* belirten dikkat çekici bir uyarı ekleyin!

Böyle bir uyarı olmadan, bu belgeyi yayınlamanın dünyanın tüm teknik sorunlarını çözmenin bizim işimiz olduğunu sanan aptallar tarafından defalarca rahatsız edildiğimizi zor yoldan öğrendik.

Eğer ki bu belgeyi yardıma ihtiyacınız olduğu için okuyorsanız ve kolayca doğrudan bu belgenin yazarlarından yardım alabileceğinizi düşünüyorsanız, *siz* bahsettiğimiz aptallardan birisiniz. *Bize* soru sormayın. Sizi görmezden geleceğiz. Biz size uğraştığınız yazılım veya donanım hakkında gerçekten bilgisi olan insanlardan nasıl yardım alabileceğinizi size göstermek için buradayız. Ancak karşılaştığınız yazılım veya donanım hakkında gerçekten bilgi sahibi %99,9 oranında biz olmayacağız. Yazarlardan birinin uğraştığınız konu hakkında uzman olduğundan kesin olarak emin değilseniz, bizi rahat bırakın, böylelikle herkes daha mutlu olacaktır.

## Giriş

[Bilgisayar üstadlarının](http://www.catb.org/~esr/faqs/hacker-howto.html) dünyasında, teknik sorularınıza alacağınız yanıtların türü, soruları sorma şeklinize olduğu kadar yanıtı geliştirmenin zorluğuna da bağlıdır. Bu kılavuz size, tatmin edici bir yanıt alma olasılığınızın daha yüksek olacağı şekilde nasıl soru soracağınızı öğretecektir.
...
Buna rağmen bilgisayar üstadları, basit soruları düşmanlık veya kibir gibi görünen bir tavırla karşılama konusunda bir üne sahiptir. Bazen yeni başlayanlara ve cahillere refleks olarak kaba davranıyormuşuz gibi görünmektedir. Ancal bu aslında doğru değildir.

Bizim, hiç çekinmeden, düşmanca davrandığımız şey, soru sormadan önce düşünmeye ya da kendi ev ödevlerini yapmaya isteksiz görünen insanlardır. Bunun gibi insanlar üstadların zamanlarını tüketirler; geri vermeden alırlar ve bizim daha ilginç başka bir soruya ve cevaba daha layık başka bir kişiye harcayabileceğimiz zamanı boşa harcarlar. Bu tür insanlara "ezikler" diyoruz (ve tarihsel nedenlerden dolayı bazen bunu "bilgisayar özürlüsü" diye yazıyoruz).

Yazdığımız yazılımı sadece kullanmak isteyen, teknik detayları öğrenmekle ilgilenmeyen pek çok kişinin olduğunun farkındayız. Çoğu insan için bilgisayar yalnızca bir araçtır, amaca yönelik bir araçtır; onların yapacak daha önemli işleri ve yaşayacak hayatları vardır. Biz bunu kabul ediyoruz ve bizi ilgilendiren teknik konularla herkesin ilgilenmesini beklemiyoruz. Bununla birlikte, soruları yanıtlama tarzımız, bu tür bir ilgi *gösteren* ve problem çözmede aktif katılımcı olmaya istekli olan kişilere göre ayarlanmıştır. Bu değişmeyecektir. Öyle de olmamalı; eğer öyle olsaydı, en iyi yaptığımız şeylerde daha az etkili olurduk.

Bizler (büyük ölçüde) gönüllüleriz. Soruları yanıtlamak için yoğun yaşamlarımızdan zaman ayırıyoruz ve zaman zaman bu sorulardan bunalıyoruz. Bu yüzden soruları (acımasızca) filtreliyoruz. Özellikle soru cevaplama zamanımızı kazananlar üzerinde daha verimli geçirmek için kaybeden gibi görünen kişilerin sorularını eliyoruz.
...
Bu nedenle, bizden ilgi görmek için zaten teknik olarak yetkin olmanız gerekmese de, yetkinliğe yol açan türde bir tutum sergilemek *gereklidir*. Uyanık, düşünceli, gözlemci, bir strateji geliştirmede aktif bir ortak olmaya istekli ve çözümün bir parçası olarak bunu gerçekleştirebilirsiniz. Bu tür bir ayrımcılıkla yaşayamıyorsanız, bilgisayar üstadlarından size kişisel olarak yardım bağışlamalarını istemek yerine, birine ticari destek sözleşmesi için ödeme yapmanızı öneririz.
...
1. Mesaj göndermeyi planladığınız forumun arşivlerini veya e-posta listesini arayarak bir cevap bulmaya çalışın.
2. Web'de arama yaparak bir yanıt bulmaya çalışın.
...
Yanlış soru sormaktan sakının. Hatalı varsayımlara dayanan bir soru sorarsanız, J. Random Hacker'ın "Aptalca bir soru" diye düşünürken ve ihtiyacınız olandan ziyade istediğinizi elde etme deneyiminin size bir ders vereceğini umarken, işe yaramaz bir şekilde gerçek bir cevapla cevap vermesi oldukça muhtemeldir.

Asla bir cevaba hakkınız olduğunu varsaymayın. Bir tek siz yoksunuz; ne de olsa hizmet için ödeme yapmıyorsunuz. Kazanırsanız, önemli, ilginç ve düşündürücü bir soru sorarak bir cevap kazanacaksınız ancak sadece pasif bir şekilde başkalarından bilgi talep etmek yerine topluluğun deneyimine dolaylı olarak katkıda bulunan bir soru sormuş olacaksınız.

Öte yandan, çözümü geliştirme sürecinde yardımcı olabileceğinizi ve yardımcı olmaya istekli olduğunuzu açıkça belirtmek çok iyi bir başlangıçtır. "Birisi bana bir ipucu verebilir mi ?", "Örneğimde eksik olan nedir?" ve "Hangi siteyi kontrol etmeliydim?" sorularının yanıtlanma olasılığı "Lütfen tam olarak kullanmam gereken prosedürü gönderin." sorusundan daha yüksektir; çünkü birisi sizi doğru yöne yönlendirebilirse süreci tamamlamaya gerçekten istekli olduğunuzu açıkça belirtiyorsunuzdur.

## Sorduğunuzda

### Forumunuzu dikkatli seçin

Sorunuzu nerede soracağınızı seçerken hassas olun. Aşağıdaki durumlarda göz ardı edilmeniz veya kaybeden olarak gözardı edileceğiniz muhtemeldir:
...
Bilgisayar üstadları, iletişim kanallarını ilgisizlik içinde boğulmaktan önlemek için, uygunsuz bir şekilde hedeflenen soruları elerler. Bunun senin başına gelmesini istemezsin.
...
Yerel kullanıcı grubunuz veya Linux dağıtımınız, yeni başlayanların yardım alabileceği bir Web forumu veya IRC kanalının reklamını yapabilir. (İngilizce konuşulmayan ülkelerde, acemi forumlarının e-posta listeleri olma olasılığı daha yüksektir.) Bunlar, özellikle nispeten basit veya yaygın bir soruna takılmış olabileceğinizi düşünüyorsanız, sormak için iyi ilk yerlerdir. Reklamı yapılan bir IRC kanalı, orada soru sormak ve genellikle gerçek zamanlı olarak yanıt almak için açık bir davettir.

Aslında, bir Linux dağıtımından size sorun çıkaran programı aldıysanız (bugün yaygın olduğu gibi), programın proje forumunu/listesini denemeden önce dağıtımın forumunda/listesinde sormak daha iyi olabilir. Projenin bilgisayar üstadları sadece "*bizim* derlediğimiz ettiğimiz yazılımı kullanın" diyebilir.

Herhangi bir Web forumuna göndermeden önce arama özelliği olup olmadığını kontrol edin. Varsa, sorununuza benzer bir şey için birkaç anahtar kelime araması yapmayı deneyin; bu size yardımcı olabilir. Daha önce genel bir Web araması yaptıysanız (olması gerektiği gibi), yine de forumda arama yapın; Web genelindeki arama motorunuzda bu forumun tamamı yakın zamanda dizine eklenmemiş olabilir.

Projelerin bir Web forumu veya IRC kanalı üzerinden kullanıcı desteği verme eğilimi giderek artmaktadır ve e-posta ile geliştirme trafiği için daha fazla ayrılmıştır. Bu nedenle, projeye özel yardım ararken önce bu kanalları arayın.

IRC'de, ilk iş olarak kanala uzun bir sorun açıklaması atmamak muhtemelen en iyisidir; Bazı insanlar bunu kanal taşması olarak yorumluyor. Kanalda bir konuşma başlatmak için tek satırlık bir sorun açıklaması yapmak en iyisidir.

### İkinci adım olarak proje posta listelerini kullanın


Bir projenin bir geliştirme posta listesi olduğunda, sorunuzu en iyi kimin yanıtlayabileceğini bildiğinize inansanız bile, tek tek geliştiricilere değil, posta listesine yazın. Bir proje posta listesinin adresi için projenin belgelerini ve ana sayfasını kontrol edin ve kullanın. Bu politikanın birkaç iyi nedeni vardır:

- Bir geliştiriciye sorulacak kadar iyi bir soru, tüm grup için de değerli olacaktır. Aksine, sorunuzun bir e-posta listesi için çok aptalca olduğundan şüpheleniyorsanız, bu bireysel geliştiricileri taciz etmek için bir bahane değildir.
- Listede soru sormak, yükü geliştiriciler arasında dağıtır. Bireysel geliştirici (özellikle proje lideriyse) sorularınızı yanıtlayamayacak kadar meşgul olabilir.
- Çoğu e-posta listesi arşivlenir ve arşivler arama motorları tarafından indekslenir. Sorunuzu listede sorarsanız ve cevaplanırsa, gelecekteki bir merak ettiğiniz sorunuzu ve cevabı tekrar sormak yerine Web'de bulabilir.
- Belirli soruların sık sık sorulduğu görülürse, geliştiriciler bu bilgileri belgeleri veya yazılımın kendisini daha az kafa karıştırıcı olacak şekilde geliştirmek için kullanabilir. Ancak bu sorular özel olarak sorulursa, hiç kimse en sık hangi soruların sorulduğuna dair tam bir resme sahip değildir.
